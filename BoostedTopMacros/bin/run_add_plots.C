{
  ...
  TFile * ttbar_cont = new TFile("kinematic_histos_ttbar.root");
  ...
  TLegend * leg0 = new TLegend(0.6, 0.55, 1.0, 1.0);
  leg0->SetFillColor(0);
  leg0->SetLineColor(0);
  THStack * hs_untagged = add_plots(leg0, "kinematic_histos", "hist_nontop_jetEt", "Jet E_{T}, Pretagged Jets;Jet E_{T} (GeV);Number Per 50 GeV");
  TH1 * hist_top_jetEt = (TH1*)ttbar_cont->Get("hist_top_jetEt");
  append_to_thstack( hs_untagged, hist_top_jetEt, leg0, "ttbar continuum", 317.0 * 1.4 / (float)1072006, 4);
  hs_untagged->Draw();
  leg0->Draw();
  ...
  TLegend * leg1 = new TLegend(0.6, 0.55, 1.0, 1.0);
  leg1->SetFillColor(0);
  leg1->SetLineColor(0);
  THStack * hs_tagged = add_plots(leg1, "kinematic_histos", "hist_tagged_nontop_jetEt", "Jet E_{T}, Tagged Jets;Jet E_{T} (GeV);Number Per 50 GeV");
  TH1 * hist_tagged_top_jetEt = (TH1*)ttbar_cont->Get("hist_tagged_top_jetEt");
  append_to_thstack( hs_tagged, hist_tagged_top_jetEt, leg1, "ttbar continuum", 317.0 * 1.4 / (float)1072006, 4);
  hs_tagged->Draw();
  leg1->Draw();
  ...
  TLegend * leg2 = new TLegend(0.6, 0.55, 1.0, 1.0);
  leg2->SetFillColor(0);
  leg2->SetLineColor(0);
  THStack * dijetmass = add_plots(leg2, "kinematic_histos", "hist_nontop_dijetmass", "Dijet Mass;Dijet Mass, Pretagged Events (GeV);Number Per 50 GeV");
  TH1 * hist_top_dijetmass = (TH1*)ttbar_cont->Get("hist_top_dijetmass");
  append_to_thstack( dijetmass, hist_top_dijetmass, leg2, "ttbar continuum", 317.0 * 1.4 / (float)1072006, 4);
  dijetmass->Draw();
  leg2->Draw();
  ...
  TLegend * leg3 = new TLegend(0.6, 0.55, 1.0, 1.0);
  leg3->SetFillColor(0);
  leg3->SetLineColor(0);
  THStack * dijetmass_tagged = add_plots(leg3, "kinematic_histos", "hist_tagged_nontop_dijetmass", "Dijet Mass, Double Tagged Events;Dijet Mass (GeV);Number Per 50 GeV");
  TH1 * hist_tagged_top_dijetmass = (TH1*)ttbar_cont->Get("hist_tagged_top_dijetmass");
  append_to_thstack( dijetmass_tagged, hist_tagged_top_dijetmass, leg3, "ttbar continuum", 317.0 * 1.4 / (float)1072006, 4);
  ...
  TLegend * leg4 = new TLegend(0.6, 0.55, 1.0, 1.0);
  leg4->SetFillColor(0);
  leg4->SetLineColor(0);
  THStack * dijetmass_onetagged = add_plots(leg4, "kinematic_histos", "hist_onetagged_nontop_dijetmass", "Dijet Mass, Single Tagged Events;Dijet Mass (GeV);Number Per 50 GeV");
  TH1 * hist_onetagged_top_dijetmass = (TH1*)ttbar_cont->Get("hist_onetagged_top_dijetmass");
  append_to_thstack( dijetmass_onetagged, hist_onetagged_top_dijetmass, leg4, "ttbar continuum", 317.0 * 1.4 / (float)1072006, 4);
...
//   THStack * hs_tagged = add_plots("kinematic_histos", "hist_nontop_dijetmass", "Dijet Mass;Mass (GeV);Number Per 20 GeV");
//   hs_tagged->GetYaxis()->SetTitleSize(0.05);
//   hs_tagged->GetYaxis()->SetLabelSize(0.04);
//   hs_tagged->GetXaxis()->SetTitleSize(0.05);
//   hs_tagged->GetXaxis()->SetLabelSize(0.04);
...
//   THStack * hs_tagged = add_plots("kinematic_histos", "hist_tagged_nontop_dijetmass", "Dijet Mass;Mass (GeV);Number Per 20 GeV");
//   hs_tagged->GetYaxis()->SetTitleSize(0.05);
//   hs_tagged->GetYaxis()->SetLabelSize(0.04);
//   hs_tagged->GetXaxis()->SetTitleSize(0.05);
//   hs_tagged->GetXaxis()->SetLabelSize(0.04);
...
//   THStack * hs_jetmass = add_plots("kinematic_histos", "hist_nontop_jetMass", "Jet Mass, Untagged Jets;Jet Mass (GeV);Number Per 10 GeV");
//   gPad->Print("qcd_untagged_jetmass.gif", "gif");

//   THStack * hs_minmass = add_plots("kinematic_histos", "hist_nontop_jetMinMass", "Jet Min Mass, Untagged Jets;Jet Min Mass (GeV);Number Per 4 GeV");
//   gPad->Print("qcd_tagged_jetmass.gif", "gif");

//   TH1D * frac = divide_thstack(hs_tagged, hs_untagged, "mistag", "Mistag Rate versus Jet E_{T};Jet E_{T} (GeV)");
