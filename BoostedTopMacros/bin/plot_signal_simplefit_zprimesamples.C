...
//     funcs[i] = hist_dijetmass->GetFunction(fitnames[i]);
    ...
    TString outname1("fit_zprime_narrow_");
    outname1 += fitnames[i];
    outname1 += ".gif";
    c0->Print(outname1.Data(), "gif");
    TString outname2("fit_zprime_narrow_");
    outname2 += fitnames[i];
    outname2 += ".eps";
  ...
  leg->Draw();
  c1->SetLogy();
  c1->Print("resolution_fits_zprime_narrow.gif", "gif");
  c1->Print("resolution_fits_zprime_narrow.eps", "eps");
  ...
  c2->Print("resolution_function_zprime_narrow.gif", "gif");
  c2->Print("resolution_function_zprime_narrow.eps", "eps");
