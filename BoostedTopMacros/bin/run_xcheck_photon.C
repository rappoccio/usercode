{
  ...
  gSystem->CompileMacro("xcheck_mistag_rate_photons_fwlite.C", "k");
...
//   xcheck_mistag_rate_fwlite(hist, "photonjet_300", false, false, 100);
//   xcheck_mistag_rate_fwlite(hist, "photonjet_470", false, false, 100);
//   xcheck_mistag_rate_fwlite(hist, "photonjet_800", false, false, 100);
//   xcheck_mistag_rate_fwlite(hist, "photonjet_1400", false, false, 100);
//   xcheck_mistag_rate_fwlite(hist, "photonjet_2200", false, false, 100);
//   xcheck_mistag_rate_fwlite(hist, "photonjet_3000", false, false, 100);


  xcheck_mistag_rate_fwlite(hist, "photonjet_300", false, true, 100);
  xcheck_mistag_rate_fwlite(hist, "photonjet_470", false, true, 100);
  xcheck_mistag_rate_fwlite(hist, "photonjet_800", false, true, 100);
  xcheck_mistag_rate_fwlite(hist, "photonjet_1400", false, true, 100);
  xcheck_mistag_rate_fwlite(hist, "photonjet_2200", false, true, 100);
  xcheck_mistag_rate_fwlite(hist, "photonjet_3000", false, true, 100);
