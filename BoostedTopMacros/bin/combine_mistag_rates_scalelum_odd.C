...
void combine_mistag_rates(double Lum = 1.0)
{
  ...
  const char * names [] = {
    "mistag_parameterization_qcd_230_v5_odd.root", 
    "mistag_parameterization_qcd_300_v5_odd.root", 
    "mistag_parameterization_qcd_380_v5_odd.root", 
    "mistag_parameterization_qcd_470_v5_odd.root", 
    "mistag_parameterization_qcd_600_v5_odd.root", 
    "mistag_parameterization_qcd_800_v5_odd.root", 
    "mistag_parameterization_qcd_1000_v5_odd.root", 
    "mistag_parameterization_qcd_1400_v5_odd.root", 
    "mistag_parameterization_qcd_1800_v5_odd.root", 
    "mistag_parameterization_qcd_2200_v5_odd.root", 
    "mistag_parameterization_qcd_2600_v5_odd.root", 
    "mistag_parameterization_qcd_3000_v5_odd.root", 
    "mistag_parameterization_qcd_3500_v5_odd.root",
...
//   };
  ...
  TFile * output = new TFile("mistag_parameterization_odd_100pb.root", "RECREATE");
  ...
  ttbar_num->Scale(Lum / 2.0);
  ttbar_den->Scale(Lum / 2.0);
...
//   mistag_rate_statsys->SetMaximum(5e-1);
  ...
  c->Print("mistag_param_lum_odd.gif", "gif");
  c->Print("mistag_param_lum_odd.eps", "eps");
