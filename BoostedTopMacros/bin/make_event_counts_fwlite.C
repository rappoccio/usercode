			     ...
			     double minMassCut1 = 50.0, double minMassCut2 = 99999.0)
{
  ...
  cout << "Number of fiducial events   = " << nfiducial << endl;
  cout << "Number of events with 2 that pass top mass cut = " << ntopmass << endl;
  cout << "Number of events with 2 that pass min mass cut = " << nminmass << endl;
