...
fsub = [
ROOT.TFile("TTjets_POWHEG_old_Var.root"),
ROOT.TFile("TTjets_POWHEG_loose_Var.root"),
ROOT.TFile("TTjets_POWHEG_btag_Var.root"),
ROOT.TFile("WJets_old_Var.root"),
ROOT.TFile("WJets_loose_Var.root"),
ROOT.TFile("WJets_btag_Var.root")
]
...
#hTTjetsold = fsub[0].Get("histMET").Clone()
#hTTjetsold.Scale(-1.)
#hQCDold.Add(hTTjetsold)
#hWJetsold = fsub[3].Get("histMET").Clone()
#hWJetsold.Scale(-1.)
#hQCDold.Add(hWJetsold)
...
#hTTjetsloose = fsub[1].Get("histMET").Clone()
#hTTjetsloose.Scale(-1.)
#hQCDloose.Add(hTTjetsloose)
#hWJetsloose = fsub[4].Get("histMET").Clone()
#hWJetsloose.Scale(-1.)
#hQCDloose.Add(hWJetsloose)
...
#hTTjetsbtag = fsub[2].Get("histMET").Clone()
#hTTjetsbtag.Scale(-1.)
#hQCDbtag.Add(hTTjetsbtag)
#hWJetsbtag = fsub[5].Get("histMET").Clone()
#hWJetsbtag.Scale(-1.)
#hQCDbtag.Add(hWJetsbtag)
