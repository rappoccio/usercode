...
if options.closureTests:
    path = [
        ## closure tests
        "python unfoldTopPt.py --closureTest --addNoBtag --ttbarPDF="+options.pdf,
        "python unfoldTopPt.py --closureTest --addNoBtag --lepType=ele --ttbarPDF="+options.pdf,
        "python unfoldTopPt.py --closureTest --addNoBtag --twoStep --ttbarPDF="+options.pdf,
        "python unfoldTopPt.py --closureTest --addNoBtag --twoStep --lepType=ele --ttbarPDF="+options.pdf,
    ]
