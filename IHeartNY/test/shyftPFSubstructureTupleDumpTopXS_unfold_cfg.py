...
if options.ignoreTrigger :
    ...
    #process.hltSelectionEle = hltHighLevel.clone(TriggerResultsTag = 'TriggerResults::HLT', HLTPaths = ['HLT_Ele30_CaloIdVT_TrkIdT_PFJet100_PFJet25_v*'])
...
process.out = cms.OutputModule("PoolOutputModule",
                               ...
                               SelectEvents   = cms.untracked.PSet( SelectEvents = cms.vstring('ptrue','p1', 'p2') ),
