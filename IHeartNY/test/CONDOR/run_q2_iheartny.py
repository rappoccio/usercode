...
samples = [
    ...
    # Q2 up
    #------------------------------
    Sample(directory='/store/user/skinnari/Unfold_24feb2015/TT_Q2up_inclusive_mu',
    ...
    Sample(directory='/store/user/skinnari/Unfold_24feb2015/TT_Q2up_700to1000_mu',
    ...
    Sample(directory='/store/user/skinnari/Unfold_24feb2015/TT_Q2up_1000toInf_mu',
    ...
    # Q2 down
    #------------------------------
    Sample(directory='/store/user/skinnari/Unfold_24feb2015/TT_Q2dn_inclusive_mu',
    ...
    Sample(directory='/store/user/skinnari/Unfold_24feb2015/TT_Q2dn_700to1000_mu',
           title='TT_Mtt-700to1000_CT10_TuneZ2star_8TeV-powheg-tauola_iheartNY_V1_mu_scaledown',
           flags='--makeResponse --semilep=1.0',
           pdfsys=False, noms=True, jersys=True, jecsys=True, btagsys=True, toptagsys=True, qcd=True, postfit=options.postfit
           ),
    Sample(directory='/store/user/skinnari/Unfold_24feb2015/TT_Q2dn_1000toInf_mu',
