...
if __name__ == "__main__":
    ...
    parser.add_option("--jetmet", action="store_const", const="jetmet", dest="elog",
                      help="Post to the JHU JetMET e-log")

    parser.add_option("--boostedtop", action="store_const", const="boostedtop", dest="elog",
                      help="Post to the JHU Boosted Top e-log")

    parser.add_option("--smpjs", action="store_const", const="smpjs", dest="elog",
                      help="Post to the JHU SMP-JS e-log")

    parser.add_option("--exotica", action="store_const", const="exotica", dest="elog",
                      help="Post to the JHU Exotica e-log")

    parser.add_option("--particleflow", action="store_const", const="particleflow", dest="elog",
                      help="Post to the JHU PF e-log")
    ...
    elif options.elog == "jetmet":
        print "Adding JetMET (JHU) specific post data."
        #form.add_field('exp','top')
        form.add_field('Type','Progress')
        form.add_field('Category','JetMET')
        form.add_field('Subject','Automatic plots posting')
        elogUrl = "http://hep.pha.jhu.edu:8080/jetmet/"
    ...
    elif options.elog == "boostedtop":
        print "Adding BoostedTop (JHU) specific post data."
        #form.add_field('exp','top')
        form.add_field('Type','Progress')
        form.add_field('Category','BoostedTop')
        form.add_field('Subject','Automatic plots posting')
        elogUrl = "http://hep.pha.jhu.edu:8080/boostedtop/"
    ...
    elif options.elog == "smpjs":
        print "Adding SMPJS (JHU) specific post data."
        #form.add_field('exp','top')
        form.add_field('Type','Progress')
        form.add_field('Category','SMPJS')
        form.add_field('Subject','Automatic plots posting')
        elogUrl = "http://hep.pha.jhu.edu:8080/smpjs/"
    ...
    elif options.elog == "exotica":
        print "Adding Exotica (JHU) specific post data."
        #form.add_field('exp','top')
        form.add_field('Type','Progress')
        form.add_field('Category','Exotica')
        form.add_field('Subject','Automatic plots posting')
        elogUrl = "http://hep.pha.jhu.edu:8080/exotica/"
    ...
    elif options.elog == "particleflow":
        print "Adding PF (JHU) specific post data."
        #form.add_field('exp','top')
        form.add_field('Type','Progress')
        form.add_field('Category','ParticleFlow')
        form.add_field('Subject','Automatic plots posting')
        elogUrl = "http://hep.pha.jhu.edu:8080/particleflow/"
    ...
    if m :
        author =  m.group(1)
        if options.elog == "shyft" or options.elog == "jetmet" or options.elog == "boostedtop" or options.elog == "exotica" or options.elog == "smpjs" or options.elog == "particleflow" :
