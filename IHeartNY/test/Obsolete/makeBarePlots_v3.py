...
if options.hist2 is None:
	...
	if options.RunAllSyst :
		...
		for ihist in xrange(len(ST_Wjets_Names)) :
			...
			##Single Top
			ST_T_t   = fT_t[ihist].Get(options.hist1).Clone()
			ST_T_t   .SetName( options.hist1 + '__T_t' + name )
			hMeas_T_t.append( ST_T_t )
			ST_Tbar_t   = fTbar_t[ihist].Get(options.hist1).Clone()
			ST_Tbar_t   .SetName( options.hist1 + '__Tbar_t' + name )
			hMeas_Tbar_t.append( ST_Tbar_t ) 
			ST_T_s   = fT_s[ihist].Get(options.hist1).Clone()
			ST_T_s   .SetName( options.hist1 + '__T_s' + name )
			hMeas_T_s.append( ST_T_s )
			ST_Tbar_s   = fTbar_s[ihist].Get(options.hist1).Clone()
			ST_Tbar_s   .SetName( options.hist1 + '__Tbar_s' + name )
			hMeas_Tbar_s.append( ST_Tbar_s )
			ST_T_tW   = fT_tW[ihist].Get(options.hist1).Clone()
			ST_T_tW   .SetName( options.hist1 + '__T_tW' + name )
			hMeas_T_tW.append( ST_T_tW )
			ST_Tbar_tW   = fTbar_tW[ihist].Get(options.hist1).Clone()
			ST_Tbar_tW   .SetName( options.hist1 + '__Tbar_tW' + name  )
			hMeas_Tbar_tW.append( ST_Tbar_tW )
			##Wjets
			W1Jets      = fW1Jets[ihist].Get(options.hist1).Clone()
			W1Jets      .SetName( options.hist1 + '__W1Jets' + name )
			hMeas_W1Jets.append( W1Jets )
			W2Jets      = fW2Jets[ihist].Get(options.hist1).Clone()
			W2Jets      .SetName( options.hist1 + '__W2Jets' + name )
			hMeas_W2Jets.append( W2Jets )
			W3Jets      = fW3Jets[ihist].Get(options.hist1).Clone()
			W3Jets      .SetName( options.hist1 + '__W3Jets' + name )
			hMeas_W3Jets.append( W3Jets )
			W4Jets      = fW4Jets[ihist].Get(options.hist1).Clone()
			W4Jets      .SetName( options.hist1 + '__W4Jets' + name )
			hMeas_W4Jets.append( W4Jets )
			del ST_T_t , ST_Tbar_t , ST_T_s , ST_Tbar_s , ST_T_tW , ST_Tbar_tW , W1Jets , W2Jets , W3Jets , W4Jets
		...
		for ihist in xrange(len(TTjets_nonSemilepTT_Names)) : 
			...
			##TT jets
			TT_Mtt_less_700      = fTT_Mtt_less_700[ihist].Get(options.hist1).Clone()
			TT_Mtt_less_700      .SetName( options.hist1 + '__TTbar_Mtt_less_700' + name )
			hMeas_TT_Mtt_less_700.append( TT_Mtt_less_700 )
			TT_Mtt_700_1000      = fTT_Mtt_700_1000[ihist].Get(options.hist1).Clone()
			TT_Mtt_700_1000      .SetName( options.hist1 + '__TTbar_Mtt_700_1000' + name )
			hMeas_TT_Mtt_700_1000.append(TT_Mtt_700_1000)
			TT_Mtt_1000_Inf      = fTT_Mtt_1000_Inf[ihist].Get(options.hist1).Clone()
			TT_Mtt_1000_Inf      .SetName( options.hist1 + '__TTbar_Mtt_1000_Inf' + name ) 
			hMeas_TT_Mtt_1000_Inf.append(TT_Mtt_1000_Inf)
			##TT nonsemileptonic jets
			TT_nonSemiLep_Mtt_less_700 = fTT_nonSemiLep_Mtt_less_700[ihist].Get(options.hist1).Clone()
			TT_nonSemiLep_Mtt_less_700 .SetName( options.hist1 + '__TTbar_nonSemiLep_Mtt_less_700' + name )
			hMeas_TT_nonSemiLep_Mtt_less_700.append(TT_nonSemiLep_Mtt_less_700)
			TT_nonSemiLep_Mtt_700_1000 = fTT_nonSemiLep_Mtt_700_1000[ihist].Get(options.hist1).Clone()
			TT_nonSemiLep_Mtt_700_1000 .SetName( options.hist1 + '__TTbar_nonSemiLep_Mtt_700_1000' + name ) 
			hMeas_TT_nonSemiLep_Mtt_700_1000.append(TT_nonSemiLep_Mtt_700_1000) 
			TT_nonSemiLep_Mtt_1000_Inf = fTT_nonSemiLep_Mtt_1000_Inf[ihist].Get(options.hist1).Clone()
			TT_nonSemiLep_Mtt_1000_Inf .SetName( options.hist1 + '__TTbar_nonSemiLep_Mtt_1000_Inf' + name )
			hMeas_TT_nonSemiLep_Mtt_1000_Inf.append(TT_nonSemiLep_Mtt_1000_Inf)
			del TT_Mtt_less_700 , TT_Mtt_700_1000 , TT_Mtt_1000_Inf , TT_nonSemiLep_Mtt_less_700 , TT_nonSemiLep_Mtt_700_1000 , TT_nonSemiLep_Mtt_1000_Inf
...
#Getting histogram files and scaling to plot histogram2 subtracted from histogram1
	...
	if options.RunAllSyst :
		...
		for ihist in xrange(len(ST_Wjets_Names)) :
			name = ST_Wjets_Names[ihist]
			##Single Top
			ST_T_t_1   = fT_t[ihist].Get(options.hist1).Clone()
			ST_T_t_1   .SetName( options.hist1 + '__T_t' + name + '__1')
			hMeas_T_t_1.append( ST_T_t_1 )
			ST_Tbar_t_1   = fTbar_t[ihist].Get(options.hist1).Clone()
			ST_Tbar_t_1   .SetName( options.hist1 + '__Tbar_t' + name + '__1' )
			hMeas_Tbar_t_1.append( ST_Tbar_t_1 ) 
			ST_T_s_1   = fT_s[ihist].Get(options.hist1).Clone()
			ST_T_s_1   .SetName( options.hist1 + '__T_s' + name + '__1' )
			hMeas_T_s_1.append( ST_T_s_1 )
			ST_Tbar_s_1   = fTbar_s[ihist].Get(options.hist1).Clone()
			ST_Tbar_s_1   .SetName( options.hist1 + '__Tbar_s' + name + '__1' )
			hMeas_Tbar_s_1.append( ST_Tbar_s_1 )
			ST_T_tW_1   = fT_tW[ihist].Get(options.hist1).Clone()
			ST_T_tW_1   .SetName( options.hist1 + '__T_tW' + name + '__1' )
			hMeas_T_tW_1.append( ST_T_tW_1 )
			ST_Tbar_tW_1   = fTbar_tW[ihist].Get(options.hist1).Clone()
			ST_Tbar_tW_1   .SetName( options.hist1 + '__Tbar_tW' + name + '__1'  )
			hMeas_Tbar_tW_1.append( ST_Tbar_tW_1)
			##Wjets
			W1Jets_1      = fW1Jets[ihist].Get(options.hist1).Clone()
			W1Jets_1      .SetName( options.hist1 + '__W1Jets' + name + '__1' )
			hMeas_W1Jets_1.append( W1Jets_1 )
			W2Jets_1      = fW2Jets[ihist].Get(options.hist1).Clone()
			W2Jets_1      .SetName( options.hist1 + '__W2Jets' + name + '__1' )
			hMeas_W2Jets_1.append( W2Jets_1 )
			W3Jets_1      = fW3Jets[ihist].Get(options.hist1).Clone()
			W3Jets_1      .SetName( options.hist1 + '__W3Jets' + name + '__1' )
			hMeas_W3Jets_1.append( W3Jets_1 )
			W4Jets_1      = fW4Jets[ihist].Get(options.hist1).Clone()
			W4Jets_1      .SetName( options.hist1 + '__W4Jets' + name + '__1' )
			hMeas_W4Jets_1.append( W4Jets_1 )
					
		TTjets_nonSemilepTT_Names = [ "__qcd" , "" , "__jec__down" , "__jec__up" , "__jer__down" , "__jer__up" , "__toptag__down" , "__toptag__up" , "__btag__down" , "__btag__up" , "__pdf__down" , "__pdf__up" , "__scale__down" , "__scale__up" ]
		for ihist in xrange(len(TTjets_nonSemilepTT_Names)) : 
			name = TTjets_nonSemilepTT_Names[ihist]
			##TT jets
			TT_Mtt_less_700_1      = fTT_Mtt_less_700[ihist].Get(options.hist1).Clone()
			TT_Mtt_less_700_1      .SetName( options.hist1 + '__TTbar_Mtt_less_700' + name + '__1' )
			hMeas_TT_Mtt_less_700_1.append( TT_Mtt_less_700_1 )
			TT_Mtt_700_1000_1      = fTT_Mtt_700_1000[ihist].Get(options.hist1).Clone()
			TT_Mtt_700_1000_1      .SetName( options.hist1 + '__TTbar_Mtt_700_1000' + name + '__1' )
			hMeas_TT_Mtt_700_1000_1.append(TT_Mtt_700_1000_1)
			TT_Mtt_1000_Inf_1      = fTT_Mtt_1000_Inf[ihist].Get(options.hist1).Clone()
			TT_Mtt_1000_Inf_1      .SetName( options.hist1 + '__TTbar_Mtt_1000_Inf' + name + '__1' ) 
			hMeas_TT_Mtt_1000_Inf_1.append(TT_Mtt_1000_Inf_1)
			##TT nonsemileptonic jets
			TT_nonSemiLep_Mtt_less_700_1      = fTT_nonSemiLep_Mtt_less_700[ihist].Get(options.hist1).Clone()
			TT_nonSemiLep_Mtt_less_700_1      .SetName( options.hist1 + '__TTbar_nonSemiLep_Mtt_less_700' + name + '__1' )
			hMeas_TT_nonSemiLep_Mtt_less_700_1.append(TT_nonSemiLep_Mtt_less_700_1)
			TT_nonSemiLep_Mtt_700_1000_1      = fTT_nonSemiLep_Mtt_700_1000[ihist].Get(options.hist1).Clone()
			TT_nonSemiLep_Mtt_700_1000_1      .SetName( options.hist1 + '__TTbar_nonSemiLep_Mtt_700_1000' + name + '__1' ) 
			hMeas_TT_nonSemiLep_Mtt_700_1000_1.append(TT_nonSemiLep_Mtt_700_1000_1) 
			TT_nonSemiLep_Mtt_1000_Inf_1      = fTT_nonSemiLep_Mtt_1000_Inf[ihist].Get(options.hist1).Clone()
			TT_nonSemiLep_Mtt_1000_Inf_1      .SetName( options.hist1 + '__TTbar_nonSemiLep_Mtt_1000_Inf' + name + '__1' )
			hMeas_TT_nonSemiLep_Mtt_1000_Inf_1.append(TT_nonSemiLep_Mtt_1000_Inf_1)
	...
	if options.RunAllSyst :
		...
		for ihist in xrange(len(ST_Wjets_Names)) :
			name = ST_Wjets_Names[ihist]
			##Single Top
			ST_T_t_2   = fT_t[ihist].Get(options.hist2).Clone()
			ST_T_t_2   .SetName( options.hist2 + '__T_t' + name + '__2')
			hMeas_T_t_2.append( ST_T_t_2 )
			ST_Tbar_t_2   = fTbar_t[ihist].Get(options.hist2).Clone()
			ST_Tbar_t_2   .SetName( options.hist2 + '__Tbar_t' + name + '__2' )
			hMeas_Tbar_t_2.append( ST_Tbar_t_2 ) 
			ST_T_s_2   = fT_s[ihist].Get(options.hist2).Clone()
			ST_T_s_2   .SetName( options.hist2 + '__T_s' + name + '__2' )
			hMeas_T_s_2.append( ST_T_s_2 )
			ST_Tbar_s_2   = fTbar_s[ihist].Get(options.hist2).Clone()
			ST_Tbar_s_2   .SetName( options.hist2 + '__Tbar_s' + name + '__2' )
			hMeas_Tbar_s_2.append( ST_Tbar_s_2 )
			ST_T_tW_2   = fT_tW[ihist].Get(options.hist2).Clone()
			ST_T_tW_2   .SetName( options.hist2 + '__T_tW' + name + '__2' )
			hMeas_T_tW_2.append( ST_T_tW_2 )
			ST_Tbar_tW_2   = fTbar_tW[ihist].Get(options.hist2).Clone()
			ST_Tbar_tW_2   .SetName( options.hist2 + '__Tbar_tW' + name + '__2'  )
			hMeas_Tbar_tW_2.append( ST_Tbar_tW_2)
			##Wjets
			W1Jets_2      = fW1Jets[ihist].Get(options.hist2).Clone()
			W1Jets_2      .SetName( options.hist2 + '__W1Jets' + name + '__2' )
			hMeas_W1Jets_2.append( W1Jets_2 )
			W2Jets_2      = fW2Jets[ihist].Get(options.hist2).Clone()
			W2Jets_2      .SetName( options.hist2 + '__W2Jets' + name + '__2' )
			hMeas_W2Jets_2.append( W2Jets_2 )
			W3Jets_2      = fW3Jets[ihist].Get(options.hist2).Clone()
			W3Jets_2      .SetName( options.hist2 + '__W3Jets' + name + '__2' )
			hMeas_W3Jets_2.append( W3Jets_2 )
			W4Jets_2      = fW4Jets[ihist].Get(options.hist2).Clone()
			W4Jets_2      .SetName( options.hist2 + '__W4Jets' + name + '__2' )
			hMeas_W4Jets_2.append( W4Jets_2 )
					
		TTjets_nonSemilepTT_Names = [ "__qcd" , "" , "__jec__down" , "__jec__up" , "__jer__down" , "__jer__up" , "__toptag__down" , "__toptag__up" , "__btag__down" , "__btag__up" , "__pdf__down" , "__pdf__up" , "__scale__down" , "__scale__up" ]
		for ihist in xrange(len(TTjets_nonSemilepTT_Names)) : 
			name = TTjets_nonSemilepTT_Names[ihist]
			##TT jets
			TT_Mtt_less_700_2      = fTT_Mtt_less_700[ihist].Get(options.hist2).Clone()
			TT_Mtt_less_700_2      .SetName( options.hist2 + '__TTbar_Mtt_less_700' + name + '__2' )
			hMeas_TT_Mtt_less_700_2.append( TT_Mtt_less_700_2 )
			TT_Mtt_700_1000_2      = fTT_Mtt_700_1000[ihist].Get(options.hist2).Clone()
			TT_Mtt_700_1000_2      .SetName( options.hist2 + '__TTbar_Mtt_700_1000' + name + '__2' )
			hMeas_TT_Mtt_700_1000_2.append(TT_Mtt_700_1000_2)
			TT_Mtt_1000_Inf_2      = fTT_Mtt_1000_Inf[ihist].Get(options.hist2).Clone()
			TT_Mtt_1000_Inf_2      .SetName( options.hist2 + '__TTbar_Mtt_1000_Inf' + name + '__2' ) 
			hMeas_TT_Mtt_1000_Inf_2.append(TT_Mtt_1000_Inf_2)
			##TT nonsemileptonic jets
			TT_nonSemiLep_Mtt_less_700_2      = fTT_nonSemiLep_Mtt_less_700[ihist].Get(options.hist2).Clone()
			TT_nonSemiLep_Mtt_less_700_2      .SetName( options.hist2 + '__TTbar_nonSemiLep_Mtt_less_700' + name + '__2' )
			hMeas_TT_nonSemiLep_Mtt_less_700_2.append(TT_nonSemiLep_Mtt_less_700_2)
			TT_nonSemiLep_Mtt_700_1000_2      = fTT_nonSemiLep_Mtt_700_1000[ihist].Get(options.hist2).Clone()
			TT_nonSemiLep_Mtt_700_1000_2      .SetName( options.hist2 + '__TTbar_nonSemiLep_Mtt_700_1000' + name + '__2' ) 
			hMeas_TT_nonSemiLep_Mtt_700_1000_2.append(TT_nonSemiLep_Mtt_700_1000_2) 
			TT_nonSemiLep_Mtt_1000_Inf_2      = fTT_nonSemiLep_Mtt_1000_Inf[ihist].Get(options.hist2).Clone()
			TT_nonSemiLep_Mtt_1000_Inf_2      .SetName( options.hist2 + '__TTbar_nonSemiLep_Mtt_1000_Inf' + name + '__2' )
			hMeas_TT_nonSemiLep_Mtt_1000_Inf_2.append(TT_nonSemiLep_Mtt_1000_Inf_2)
...
if options.RunAllSyst :
	...
	for ihist in xrange(len(ST_Wjets_Names)) :
		name = ST_Wjets_Names[ihist]
		WJets      = hMeas_W1Jets[ihist].Clone()
		WJets      .SetName( histname + '__WJets' + name )
		hMeas_WJets.append( WJets )
		for hist in [ hMeas_W2Jets[ihist], hMeas_W3Jets[ihist], hMeas_W4Jets[ihist] ] :
			hMeas_WJets[ihist].Add( hist )
		SingleTop      = hMeas_T_t[ihist].Clone()
		SingleTop      .SetName(histname + '__SingleTop' + name )
		hMeas_SingleTop.append(SingleTop) 
	...
	for ihist in xrange(len(TTjets_nonSemilepTT_Names)):
		name = TTjets_nonSemilepTT_Names[ihist]
		TTbar      = hMeas_TT_Mtt_less_700[ihist].Clone()
		TTbar      .SetName(histname + '__TTbar' + name )
		hMeas_TTbar.append(TTbar)
		for hist in [hMeas_TT_Mtt_700_1000[ihist], hMeas_TT_Mtt_1000_Inf[ihist]] :
			hMeas_TTbar[ihist].Add( hist )
		TTbar_nonSemiLep      = hMeas_TT_nonSemiLep_Mtt_less_700[ihist].Clone()
		TTbar_nonSemiLep      .SetName(histname + '__TTbar_nonSemiLep' +name )
		hMeas_TTbar_nonSemiLep.append( TTbar_nonSemiLep )
...
if 'hadtop_pt3' in options.hist1 :
...
if 'hadtop_pt4' in options.hist1 :
...
if 'hadtop_pt6' in options.hist1 or 'hadtop_pt7' in options.hist1 :
    hRecoData.SetAxisRange(350,1200,"X")
if 'hadtop_y' in options.hist1 or 'leptop_y' in options.hist1 :
...
for m in range(1,len(plots)):
    ...
    if "etaAbs" in options.hist1 or "lepMET" in options.hist1 or "leptop_mass" in options.hist1:
        max = max*1.2
    elif "eta" in options.hist1 or "_y" in options.hist1  or "wboson_mt" in options.hist1 or "wboson_pt" in options.hist1:
        max = max*1.4
    ...
    if 'etaAbsLep' in options.hist1 :
        hMeas_TTbar[m].GetXaxis().SetTitle("Muon |#eta|")
    ...
    if options.hist2 is None:
    	if not options.ignoreData : 
        	c.Print( 'NicePlots/normalized_' + plots[m] + '_' + options.outname + '_' + options.hist1 + '.png' )
        	c.Print( 'NicePlots/normalized_' + plots[m] + '_' + options.outname + '_' + options.hist1 + '.pdf' )
        	c.Print( 'NicePlots/normalized_' + plots[m] + '_' + options.outname + '_' + options.hist1 + '.eps' )
    	else : 
