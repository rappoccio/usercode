...
int binfac = 8;
TString binsize = "80";     // 10 * binfac
TString numberofbins = "5"; // 40 / binfac
...
double* getTemp(int binfac, bool btag, bool dosub){
  ...
  TString top_cont_names[3] = {"topttbar", "topstop", "topwjets"};
  for(int i=0; i<3; i++){
  ...
  leg1->AddEntry(top_cont_array[2], " W+Jets", "F");
  ...
  leg2->AddEntry(top_cont_array[2], " W+Jets", "L");
