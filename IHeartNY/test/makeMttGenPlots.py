...
hMeas_SingleTop = []
# ttbar 
fTT_Mtt_less_700_nom       = TFile("TT_max700_CT10_TuneZ2star_8TeV-powheg-tauola_iheartNY_V1_mu_nom.root")
fTT_Mtt_less_700_scaledown = TFile("TT_max700_CT10_TuneZ2star_8TeV-powheg-tauola_iheartNY_V1_mu_scaledown_nom.root")
fTT_Mtt_less_700_scaleup   = TFile("TT_max700_CT10_TuneZ2star_8TeV-powheg-tauola_iheartNY_V1_mu_scaleup_nom.root")

fTT_Mtt_700_1000_nom       = TFile("TT_Mtt-700to1000_CT10_TuneZ2star_8TeV-powheg-tauola_iheartNY_V1_mu_nom.root")
fTT_Mtt_700_1000_scaledown = TFile("TT_Mtt-700to1000_CT10_TuneZ2star_8TeV-powheg-tauola_iheartNY_V1_mu_scaledown_nom.root")
fTT_Mtt_700_1000_scaleup   = TFile("TT_Mtt-700to1000_CT10_TuneZ2star_8TeV-powheg-tauola_iheartNY_V1_mu_scaleup_nom.root")

fTT_Mtt_1000_Inf_nom       = TFile("TT_Mtt-1000toInf_CT10_TuneZ2star_8TeV-powheg-tauola_iheartNY_V1_mu_nom.root")
fTT_Mtt_1000_Inf_scaledown = TFile("TT_Mtt-1000toInf_CT10_TuneZ2star_8TeV-powheg-tauola_iheartNY_V1_mu_scaledown_nom.root")
fTT_Mtt_1000_Inf_scaleup   = TFile("TT_Mtt-1000toInf_CT10_TuneZ2star_8TeV-powheg-tauola_iheartNY_V1_mu_scaleup_nom.root")
...
ttbar_nom_stack.SetMaximum(options.maxy)
...
ttbar_scaleup_stack.SetMaximum(options.maxy)
...
ttbar_scaledown_stack.SetMaximum(options.maxy)
...
ttbar_canv.Print("q2woes_" + options.hist1 + ".pdf", "pdf")
ttbar_canv.Print("q2woes" + options.hist1 + ".png", "png")
...
hMeas_TT_Mtt_sum_scaledown.SetMaximum(options.maxy)
...
leg.Draw()
sumcanv.Print("q2var" + options.hist1 + ".pdf", "pdf")
sumcanv.Print("q2var" + options.hist1 + ".png", "png")
