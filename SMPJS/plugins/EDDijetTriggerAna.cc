// -*- C++ -*-
//
// Package:    EDDijetTriggerAna
// Class:      EDDijetTriggerAna
// 
/**\class EDDijetTriggerAna EDDijetTriggerAna.cc Analysis/EDDijetTriggerAna/src/EDDijetTriggerAna.cc
...
// $Id: EDDijetTriggerAna.cc,v 1.2 2011/10/07 18:19:25 srappocc Exp $
//
//
...
class EDDijetTriggerAna : public edm::EDAnalyzer {
   public:
      explicit EDDijetTriggerAna(const edm::ParameterSet&);
      ~EDDijetTriggerAna();
...
//
EDDijetTriggerAna::EDDijetTriggerAna(const edm::ParameterSet& iConfig)
...
EDDijetTriggerAna::~EDDijetTriggerAna()
{
...
void
EDDijetTriggerAna::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  if ( !inTable_ )
    return;
   ...
   if ( jets.size() >= 2 ) {
     ...
     double ptAvg = (jet0.pt() + jet1.pt()) * 0.5;
	 ...
	 cout << "pt0 = " << jet0.pt() << ", pt1 = " << jet1.pt() << ", ptAvg = " << ptAvg << endl;
       }
       jetPtDen->Fill( ptAvg );
       pass = true;
       ++nTotal_;
...
void 
EDDijetTriggerAna::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
EDDijetTriggerAna::endJob() 
{
...
void 
EDDijetTriggerAna::beginRun(edm::Run const& run , edm::EventSetup const& eventSetup)
{
...
void 
EDDijetTriggerAna::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
EDDijetTriggerAna::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
EDDijetTriggerAna::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
EDDijetTriggerAna::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
void 
EDDijetTriggerAna::getAodTriggerObjectsForModule (edm::InputTag collectionTag,
                                                  edm::Handle<trigger::TriggerEvent> aodTriggerEvent,
                                                  trigger::TriggerObjectCollection trigObjs,
                                                  std::vector<TriggerObject> & foundObjects  ) {
...
DEFINE_FWK_MODULE(EDDijetTriggerAna);
