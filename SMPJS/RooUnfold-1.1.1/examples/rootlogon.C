{
  ...
  makeshared.ReplaceAll("-W ", "");
  makeshared.ReplaceAll("-Wshadow ", "");
  gSystem->SetMakeSharedLib(makeshared);

  string arch(gSystem->GetBuildArch());
  string dyldfallbackpath(gSystem->Getenv("DYLD_FALLBACK_LIBRARY_PATH"));
  if (arch == "macosx64" && dyldfallbackpath.size() > 0) {
    gSystem->SetDynamicPath(dyldfallbackpath.c_str());
  }

  gSystem->Load("libFWCoreFWLite");
  AutoLibraryLoader::enable();
  gSystem->Load("libDataFormatsFWLite");
  gSystem->Load("/Users/rappocc/fwlite/CMSSW_4_2_3_FWLITE/src/Analysis/SMPJS/RooUnfold-1.1.1/libRooUnfold");
  cout << "Welcome to FWLite" << endl;
  ...
  path += "-I. -I$ROOTSYS/src -I/Applications/FWLite/CMSSW_4_2_3_FWLITE/osx106_amd64_gcc421/lcg/roofit/5.28.00a-cms6/include -I../";
