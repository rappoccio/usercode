...
class MultijetSelector : public EventSelector {
public:
  MultijetSelector( edm::ParameterSet const & caloJetIdParams,
...
int main (int argc, char* argv[]) 
{
  ...
  MultijetSelector caloSelector( caloJetIDParameters,
				 pfJetIDParameters,
				 jetStudiesParams );

  MultijetSelector pfSelector( caloJetIDParameters,
			       pfJetIDParameters,
			       pfJetStudiesParams );
