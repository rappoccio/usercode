#ifndef Analysis_BoostedTop_interface_BoostedTopProducer_h
#define Analysis_BoostedTop_interface_BoostedTopProducer_h
...
// 
/**\class BoostedTopProducer BoostedTopProducer.cc Analysis/BoostedTopProducer/src/BoostedTopProducer.cc
