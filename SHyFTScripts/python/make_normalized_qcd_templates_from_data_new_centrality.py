...
untaghists2d = []
taghists2d = []
untaghist = 'Data_lepIsoVsCentral_'
...
for ijet in range(1,6):
    ...
    if options.taggedHist.find( 'secvtxMass' ) > -1 :
        ...
        # first fill up the tagged histograms
        taghists2d.append( h_1tag )
        h_1tag_proj = h_1tag.ProjectionX( 'proj_Data_Central_' + str(ijet) + '_1t', 9, h_1tag.GetNbinsY()+1 )
        h_1tag_proj.SetMarkerStyle(20)
        taghists.append( h_1tag_proj )            


    untaghists2d.append( h_0tag )
    h_0tag_proj = h_0tag.ProjectionX( 'proj_Data_Central_' + str(ijet) + '_0t', 9, h_0tag.GetNbinsY()+1 )
...
if options.taggedHist.find( 'secvtxMass' ) > -1 :
    ...
    untaghists[3].SetName( 'proj_Data_Central_4_0t')
    untaghists[4].SetName( 'proj_Data_Central_5_0t')
