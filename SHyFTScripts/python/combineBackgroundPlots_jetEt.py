...
if useDataQCD :
    ...
    qcd_0tag_data_names = [
    'proj_Data_jetEt_1_0t',
    'proj_Data_jetEt_2_0t',
    'proj_Data_jetEt_3_0t',
    'proj_Data_jetEt_4_0t',
    'proj_Data_jetEt_5_0t'
    ...
    if options.makePretagPlots is False:
        ...
        qcd_data_names = [
            'proj_Data_jetEt_1_1t',
            'proj_Data_jetEt_2_1t',
            'proj_Data_jetEt_3_1t',
            'proj_Data_jetEt_4_1t',
            'proj_Data_jetEt_5_1t'            
            ]        

    for ijet in range (1, maxJets):
        #print options.dataQCDFile
        #print qcd_0tag_data_names[ijet-1]
        #f_qcd_data.Print()
        #f_qcd_data.ls()
        h0 = f_qcd_data.Get( qcd_0tag_data_names[ijet-1]).Clone()
        h0.SetName('QCD_B_jetEt_'+ str(ijet) + 'j_0t')
        ...
        if options.makePretagPlots is False :
            ...
            h1.SetName('QCD_B_jetEt_'+ str(ijet) + 'j_1t')            
        ...
        if ijet > 1 :
            if options.makePretagPlots is False :
                ...
                h2 = TH1F('QCD_B_jetEt_'+ str(ijet) + 'j_2t',
                          'QCD_B_jetEt_'+ str(ijet) + 'j_2t',
                          h1.GetNbinsX(),
                          h1.GetXaxis().GetBinLowEdge(1),
                          h1.GetXaxis().GetBinLowEdge(h1.GetNbinsX() + 1),
                          )
