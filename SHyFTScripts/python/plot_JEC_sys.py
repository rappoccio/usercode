...
c1 = TCanvas('c1', 'c1')
h_njets_1 = f.Get('pfShyftAnaJES095/nJets')
h_njets_2 = f.Get('pfShyftAna/nJets')
h_njets_3 = f.Get('pfShyftAnaJES105/nJets')
...
leg.AddEntry(h_njets_1, 'JEC Down', 'l')
leg.AddEntry(h_njets_2, 'JEC Nominal', 'l')
leg.AddEntry(h_njets_3, 'JEC Up', 'l')
...
c2 = TCanvas('c2', 'c2')
h_jet1Pt_1 = f.Get('pfShyftAnaJES095/jet1Pt')
h_jet1Pt_2 = f.Get('pfShyftAna/jet1Pt')
h_jet1Pt_3 = f.Get('pfShyftAnaJES105/jet1Pt')
...
c3 = TCanvas('c3', 'c3')
h_jet2Pt_1 = f.Get('pfShyftAnaJES095/jet2Pt')
h_jet2Pt_2 = f.Get('pfShyftAna/jet2Pt')
h_jet2Pt_3 = f.Get('pfShyftAnaJES105/jet2Pt')
...
c4 = TCanvas('c4', 'c4')
h_jet3Pt_1 = f.Get('pfShyftAnaJES095/jet3Pt')
h_jet3Pt_2 = f.Get('pfShyftAna/jet3Pt')
h_jet3Pt_3 = f.Get('pfShyftAnaJES105/jet3Pt')
...
c5 = TCanvas('c4', 'c4')
h_jet4Pt_1 = f.Get('pfShyftAnaJES095/jet4Pt')
h_jet4Pt_2 = f.Get('pfShyftAna/jet4Pt')
h_jet4Pt_3 = f.Get('pfShyftAnaJES105/jet4Pt')
...
latex.DrawLatex(0.6,0.96, "CMS Preliminary")
#latex.DrawLatex(0.6,0.92,"#int Ldt = 771 pb^{-1}")
#c5.Print('jec_sys_jet4Pt_ele.png', 'png')
c5.Print('jec_sys_jet4Pt_ele.pdf', 'pdf')


c6 = TCanvas('c6', 'c6')
h_metPt_1 = f.Get('pfShyftAnaJES095/metPt')
h_metPt_2 = f.Get('pfShyftAna/metPt')
h_metPt_3 = f.Get('pfShyftAnaJES105/metPt')
...
latex.SetTextSize(0.04)
latex.DrawLatex(0.6,0.96, "CMS Preliminary")
#c6.Print('jec_sys_metPt_ele.png', 'png')
c6.Print('jec_sys_metPt_ele.pdf', 'pdf')
