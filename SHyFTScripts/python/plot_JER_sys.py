...
c1 = TCanvas('c1', 'c1')
h_njets_1 = f.Get('pfRecoShyftAnaJER000/nJets')
h_njets_2 = f.Get('pfRecoShyftAna/nJets')
h_njets_3 = f.Get('pfRecoShyftAnaJER020/nJets')
...
c2 = TCanvas('c2', 'c2')
h_jet1Pt_1 = f.Get('pfRecoShyftAnaJER000/jet1Pt')
h_jet1Pt_2 = f.Get('pfRecoShyftAna/jet1Pt')
h_jet1Pt_3 = f.Get('pfRecoShyftAnaJER020/jet1Pt')
...
c3 = TCanvas('c3', 'c3')
h_jet2Pt_1 = f.Get('pfRecoShyftAnaJER000/jet2Pt')
h_jet2Pt_2 = f.Get('pfRecoShyftAna/jet2Pt')
h_jet2Pt_3 = f.Get('pfRecoShyftAnaJER020/jet2Pt')
...
c4 = TCanvas('c4', 'c4')
h_jet3Pt_1 = f.Get('pfRecoShyftAnaJER000/jet3Pt')
h_jet3Pt_2 = f.Get('pfRecoShyftAna/jet3Pt')
h_jet3Pt_3 = f.Get('pfRecoShyftAnaJER020/jet3Pt')
...
c5 = TCanvas('c5', 'c5')
h_metPt_1 = f.Get('pfRecoShyftAnaJER000/metPt')
h_metPt_2 = f.Get('pfRecoShyftAna/metPt')
h_metPt_3 = f.Get('pfRecoShyftAnaJER020/metPt')
...
leg.Draw()
c5.Print('jer_sys_metPt_ele.png', 'png')
c5.Print('jer_sys_metPt_ele.pdf', 'pdf')
