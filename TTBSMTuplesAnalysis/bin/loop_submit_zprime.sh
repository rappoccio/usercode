...
do
	...
	python TTHadronicAnalyzerCombined.py --dirs=/uscms_data/d2/jdolen/BoostedTop424Ntuple/CMSSW_4_2_4/src/Analysis/TTBSMPatTuples/test/retry/${DIR}/res/ --outfile=TTHadronicAnalyzerCombined_${DIR}_trig2 --analyzer=Type11Analyzer --mistagFile=MISTAG_RATE_TYPE1_SUBTRACT --useMC
done
