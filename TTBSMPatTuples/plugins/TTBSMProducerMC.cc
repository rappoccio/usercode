...
class TTBSMProducerMC : public edm::EDFilter {
   public:
      explicit TTBSMProducerMC(const edm::ParameterSet&);
      ~TTBSMProducerMC();
...
//
TTBSMProducerMC::TTBSMProducerMC(const edm::ParameterSet& iConfig) :
...
TTBSMProducerMC::~TTBSMProducerMC()
{
}
...
bool
TTBSMProducerMC::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void 
TTBSMProducerMC::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
TTBSMProducerMC::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(TTBSMProducerMC);
