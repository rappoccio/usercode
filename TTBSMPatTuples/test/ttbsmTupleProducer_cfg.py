...
'dcap://cmsdca.fnal.gov:24136/pnfs/fnal.gov/usr/cms/WAX/11/store/user/lpctlbsm/srappocc/Jet/ttbsm_v8_Run2011-May10ReReco/0d3d9a54f3a29af186ad87df2a0c3ce1/ttbsm_42x_data_75_1_QBL.root'
                                    )
                                )
...
'dcap:///pnfs/cms/WAX/11/store/user/lpctlbsm/guofan/HT/ttbsm_v5_Run2011A-May10ReReco-v1/66893cf1a11d0e3066e5097c4fdc37a6/ttbsm_42x_data_74_1_PRV.root',
    ...
    mytrigs1 = ['HLT_Jet370*', "HLT_Jet300*"]
    mytrigs2 = ['HLT_HT500*']
    mytrigs = []
    from HLTrigger.HLTfilters.hltHighLevel_cfi import *
