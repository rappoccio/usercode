...
import sys
#TTSemilepAnalyzer_19invfb_TTWeight_type1_eta_range1.root
...
fTopSL =  ROOT.TFile("TTSemilepAnalyzer_TTJets_"+MCstring+"_TTWeight_ptWeighted_type1"+etastring+".root")


fWMC = ROOT.TFile("TTSemilepAnalyzer_WJets_"+MCstring+"_TTWeight_ptWeighted_type1"+etastring+".root")
fZJetsMC = ROOT.TFile("TTSemilepAnalyzer_ZJets_"+MCstring+"_TTWeight_ptWeighted_type1"+etastring+".root")
fSingletop = [
ROOT.TFile("TTSemilepAnalyzer_ST_t_"+MCstring+"_TTWeight_ptWeighted_type1"+etastring+".root"),
ROOT.TFile("TTSemilepAnalyzer_ST_tB_"+MCstring+"_TTWeight_ptWeighted_type1"+etastring+".root"),
ROOT.TFile("TTSemilepAnalyzer_ST_tW_"+MCstring+"_TTWeight_ptWeighted_type1"+etastring+".root"),
ROOT.TFile("TTSemilepAnalyzer_ST_tWB_"+MCstring+"_TTWeight_ptWeighted_type1"+etastring+".root"),
ROOT.TFile("TTSemilepAnalyzer_ST_s_"+MCstring+"_TTWeight_ptWeighted_type1"+etastring+".root"),
ROOT.TFile("TTSemilepAnalyzer_ST_sB_"+MCstring+"_TTWeight_ptWeighted_type1"+etastring+".root"),
]
...
for t1hist in t1hists:
	...
	if i==0:
		...
		leg.AddEntry( t1ttbarSL, 't#bar{t}', 'f')
	...
	c.Print( 'semiLepMass_'+t1titles[i]+'_'+MCstring+etastring+'_TTWeight.root', 'root')
	c.Print( 'semiLepMass_'+t1titles[i]+'_'+MCstring+etastring+'_TTWeight.pdf', 'pdf')
	i+=1
temp=1.0
temperror=0.0
