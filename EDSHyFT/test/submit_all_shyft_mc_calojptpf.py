...
for dataset in datasets :
    ...
    s = './my_multicrab.pl crab_dummy_shyft.cfg shyft.py '  + dataset[0] + ' shyft_38xOn35x_v2 -1 ' + str(dataset[1]) + ' condor 0 ' + idir + ' ' + toks[1] + '_shyft_38xOn35x_v2'
    print s
...
for dataset in datasetsServer :
    toks = dataset[0].split('/')
    s = './my_multicrab.pl crab_dummy_shyft.cfg shyft.py '  + dataset[0] + ' shyft_38xOn35x_v2 -1 ' + str(dataset[1]) + ' glite 1 ' + idir + ' ' + toks[1] + '_shyft_38xOn35x_v2'
    print s
    subprocess.call( [s], shell=True )
