...
if runData:
    ...
    process.p1 = cms.Path( process.hltSelectionEle * process.goodPatJetsPFSF * process.pfTupleEle)
    process.p2 = cms.Path()
    process.p3 = cms.Path( process.hltSelectionEle * process.pfTupleEleCA8Pruned)
    process.p4 = cms.Path()
    process.p5 = cms.Path( process.hltSelectionEle * process.goodPatJetsPFSF * process.pfTupleEleLoose)
    process.p6 = cms.Path()
    process.p7 = cms.Path( process.pileupReweightingProducer * process.GenInfo )
    process.p8 = cms.Path( process.hltSelectionEle * process.goodPatJetsPFSF * process.pfTupleEleMetRes090)
    process.p9 = cms.Path( process.hltSelectionEle * process.goodPatJetsPFSF * process.pfTupleEleMetRes110)
    process.p10 = cms.Path()
    process.p11 = cms.Path()
elif options.runMuonQCDSamples:
    process.p1 = cms.Path()
    process.p2 = cms.Path( process.hltSelectionMu * process.goodPatJetsPFSF * process.pfTupleMu)
    process.p3 = cms.Path()
    process.p4 = cms.Path( process.hltSelectionMu * process.pfTupleMuCA8Pruned)
    process.p5 = cms.Path()
    process.p6 = cms.Path( process.hltSelectionMu * process.goodPatJetsPFSF * process.pfTupleMuLoose)
    process.p7 = cms.Path( process.pileupReweightingProducer * process.GenInfo )
    process.p8 = cms.Path()
    process.p9 = cms.Path()
    process.p10 = cms.Path( process.hltSelectionMu * process.goodPatJetsPFSF * process.pfTupleMuMetRes090)
    process.p11 = cms.Path( process.hltSelectionMu * process.goodPatJetsPFSF * process.pfTupleMuMetRes110)  
else:
    process.p1 = cms.Path( process.hltSelectionEle * process.goodPatJetsPFSF * process.pfTupleEle)
    process.p2 = cms.Path( process.hltSelectionMu * process.goodPatJetsPFSF * process.pfTupleMu)
    process.p3 = cms.Path( process.hltSelectionEle * process.pfTupleEleCA8Pruned)
