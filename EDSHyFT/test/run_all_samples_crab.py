...
dummy_config_name = 'crab_dummy_anashyft_ele_fit.cfg'

dummy_config = ConfigParser.RawConfigParser()
dummy_config.read(dummy_config_name)

pset = 'shyftTupleDump_cfg.py'
working_dir = os.environ['HOME'] + '/nobackup/ntuplesShyftNew_data/'
dir_suffix = '_ttbsm_v9_try1'
...
##      'number_of_jobs':'15', 'pycfg_params':'useData=0', '#sample_name': 'PhoJet40100' },
...
##      'number_of_jobs':'15', 'pycfg_params':'useData=0', '#sample_name': 'PhoJet100200' },
...
##      'number_of_jobs':'15', 'pycfg_params':'useData=0', '#sample_name': 'PhoJet200Inf' },
