...
datasets = [
  ...
  [
    ...
    'TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_AK5PF_CSVM'  # output filename
  ],
  [
    ...
    'WJetsToLNu_TuneZ2Star_8TeV-madgraph-tarball_AK5PF_CSVM'
  ],
  [
    ...
    'DYJetsToLL_M-50_TuneZ2Star_8TeV-madgraph-tarball_AK5PF_CSVM'
  ],
  [
    ...
    'T_s-channel_TuneZ2star_8TeV-powheg-tauola_AK5PF_CSVM'
  ],
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 150., 200., 300., 1000.],[0., 0.6, 1.2, 2.4]],
     'c':    [[0., 40., 60., 80., 100., 150., 1000.],[0., 0.6, 1.2, 2.4]],
     'udsg': [[0., 40., 60., 80., 100., 1000.],[0., 0.6, 1.2, 2.4]]},
    'T_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola_AK5PF_CSVM'
  ],
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 150., 200., 300., 1000.],[0., 0.6, 1.2, 2.4]],
     'c':    [[0., 40., 60., 80., 100., 150., 1000.],[0., 0.6, 1.2, 2.4]],
     'udsg': [[0., 40., 60., 80., 100., 150., 1000.],[0., 0.6, 1.2, 2.4]]},
    'T_t-channel_TuneZ2star_8TeV-powheg-tauola_AK5PF_CSVM'
  ],
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 120., 240., 1000.],[0., 0.6, 1.2, 2.4]],
     'c':    [[0., 40., 60., 80., 100., 1000.],[0., 0.6, 1.2, 2.4]],
     'udsg': [[0., 40., 60., 80., 100., 1000.],[0., 0.6, 1.2, 2.4]]},
    'Tbar_s-channel_TuneZ2star_8TeV-powheg-tauola_AK5PF_CSVM'
  ],
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 150., 200., 300., 1000.],[0., 0.6, 1.2, 2.4]],
     'c':    [[0., 40., 60., 80., 100., 150., 1000.],[0., 0.6, 1.2, 2.4]],
     'udsg': [[0., 40., 60., 80., 100., 1000.],[0., 0.6, 1.2, 2.4]]},
    'Tbar_tW-channel-DR_TuneZ2star_8TeV-powheg-tauola_AK5PF_CSVM'
  ],
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 150., 200., 300., 1000.],[0., 0.6, 1.2, 2.4]],
     'c':    [[0., 40., 60., 80., 100., 150., 1000.],[0., 0.6, 1.2, 2.4]],
     'udsg': [[0., 40., 60., 80., 100., 150., 1000.],[0., 0.6, 1.2, 2.4]]},
    'Tbar_t-channel_TuneZ2star_8TeV-powheg-tauola_AK5PF_CSVM'
  ],
  [
    ...
    'WW_TuneZ2star_8TeV_pythia6_tauola_AK5PF_CSVM'
  ],
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 150., 200., 300., 1000.],[0., 0.6, 1.2, 2.4]],
     'c':    [[0., 40., 60., 80., 100., 150., 200., 1000.],[0., 0.6, 1.2, 2.4]],
     'udsg': [[0., 40., 60., 80., 100., 150., 200., 1000.],[0., 0.6, 1.2, 2.4]]},
    'WZ_TuneZ2star_8TeV_pythia6_tauola_AK5PF_CSVM'
  ],
  # Signal
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 150., 200., 300., 1000.],[0., 0.6, 1.2, 2.4]],
     'c':    [[0., 40., 60., 80., 100., 150., 200., 1000.],[0., 0.6, 1.2, 2.4]],
     'udsg': [[0., 40., 60., 80., 100., 150., 200., 1000.],[0., 0.6, 1.2, 2.4]]},
    'BprimeBprimeToTWTWinc_M-450_TuneZ2star_8TeV-madgraph_AK5PF_CSVM'
  ],
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 150., 200., 300., 500., 1000.],[0., 0.6, 1.2, 2.4]],
     ...
     'udsg': [[0., 40., 60., 80., 100., 150., 200., 1000.],[0., 0.6, 1.2, 2.4]]},
    'BprimeBprimeToTWTWinc_M-750_TuneZ2star_8TeV-madgraph_AK5PF_CSVM'
  ],
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 150., 200., 300., 400., 1000.],[0., 0.6, 1.2, 2.4]],
     'c':    [[0., 40., 60., 80., 100., 150., 200., 300., 1000.],[0., 0.6, 1.2, 2.4]],
     'udsg': [[0., 40., 60., 80., 100., 150., 200., 1000.],[0., 0.6, 1.2, 2.4]]},
    'BprimeBprimeToBZTWinc_M-600_TuneZ2star_8TeV-madgraph_AK5PF_CSVM'
  ],
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 150., 200., 300., 500., 1000.],[0., 0.6, 1.2, 2.4]],
     'c':    [[0., 40., 60., 80., 100., 150., 200., 300., 1000.],[0., 0.6, 1.2, 2.4]],
     'udsg': [[0., 40., 60., 80., 100., 150., 200., 1000.],[0., 0.6, 1.2, 2.4]]},
    'BprimeBprimeToBZTWinc_M-750_TuneZ2star_8TeV-madgraph_AK5PF_CSVM'
  ],
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 150., 200., 300., 400., 1000.],[0., 0.6, 1.2, 2.4]],
     'c':    [[0., 40., 60., 80., 100., 150., 200., 300., 1000.],[0., 0.6, 1.2, 2.4]],
     'udsg': [[0., 40., 60., 80., 100., 150., 200., 1000.],[0., 0.6, 1.2, 2.4]]},
    'BprimeBprimeToBHBHinc_M-600_TuneZ2star_8TeV-madgraph_AK5PF_CSVM'
  ],
  [
    ...
    {'b':    [[0., 40., 60., 80., 100., 150., 200., 300., 500., 1000.],[0., 0.6, 1.2, 2.4]],
     'c':    [[0., 40., 60., 80., 100., 150., 200., 1000.],[0., 0.6, 1.2, 2.4]],
     'udsg': [[0., 40., 60., 80., 100., 150., 200., 1000.],[0., 0.6, 1.2, 2.4]]},
    'BprimeBprimeToBHBHinc_M-800_TuneZ2star_8TeV-madgraph_AK5PF_CSVM'
  ]
]
